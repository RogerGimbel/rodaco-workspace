...
**After major work sessions or conversations, run `/save`:**
- Flushes context to daily notes
- Extracts facts to knowledge graph
- Commits changes to git

Don't wait until end of day. Checkpoint often.
