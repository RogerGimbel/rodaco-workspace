...
## Current Status
- **Phase**: Active — native app conversion + marketing
- **URL**: https://beerpair.com
- **Company**: [[Rodaco]]

## Description
Food and beer pairing web app. Users input a dish, get craft beer pairing recommendations.
...
- Hosting: Vercel
- Domain: IONOS
- Native: Despia WebView wrapper (in progress)

## Team
- **Dev**: [[Roger Gimbel]] (via Lovable)
- **Marketing**: [[Stuart Seligman]] (B2B venue strategy)
- **Business**: [[Dale Abbott]] (financing, strategy)
