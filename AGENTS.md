...
## Sub-Agent Knowledge Context

When spawning sub-agents (`sessions_spawn`) or writing cron job prompts:
- Check `knowledge/INDEX.md` for relevant KB paths
- Include them in the task description so the sub-agent can load context:
  ```
  "Audit BeerPair SEO. Load: knowledge/projects/beerpair/summary.md"
  ```
- For broad tasks, point to the INDEX: "Consult knowledge/INDEX.md for relevant entities."
- Sub-agents don't inherit your conversation — they start cold. Give them what they need.
