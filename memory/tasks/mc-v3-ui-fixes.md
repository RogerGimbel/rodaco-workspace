...
### P0 — Must Fix
- [ ] **1. "active" badge contrast (Ops page)**
...
- [ ] **2. "BeerPair" project tag contrast (Research page)**
...
### P1 — Should Fix
- [ ] **4. Broken Unicode in Last Backup card (Home)**
...
- [ ] **5. "ACTIVE TASKS" duplicate label (Home)**
...
- [ ] **6. Gateway latency semantic color (Home)**
...
- [ ] **7. Cost period toggle active state (Home)**
...
### P2 — Nice to Have
- [ ] **10. Pi device card disk label wrapping**
...
- [ ] **11. System Health bars — no labels**
